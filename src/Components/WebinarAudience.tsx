  ...
  return (
    <div className="text-gray-800 py-8 px-6 rounded-lg shadow-lg mt-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="border-2 border-white text-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
        ...
        <div className="border-2  text-white p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
